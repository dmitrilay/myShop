...
class CategoryFeature(models.Model):
    ...
    class Meta:
        ...
        verbose_name = 'Характеристики для определенной категории'
        verbose_name_plural = 'Характеристики для определенной категории'
...
class ProductFeatures(models.Model):
    ...
    class Meta:
        verbose_name = 'Привязка характеристик к товару'
        verbose_name_plural = 'Привязка характеристик к товару'
